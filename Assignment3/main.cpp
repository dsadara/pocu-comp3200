...
void TestSmartStack()
{
    ...
    assert(ss.GetMax() == std::numeric_limits<float>::min());
    ...
    assert(ss2.GetMax() != std::numeric_limits<float>::min());
...
void TestMinMaxWhenEmpty()
{
    ...
    SmartStack<float> s3;
    assert(s3.GetMax() == std::numeric_limits<float>::min());
    assert(s3.GetMin() == std::numeric_limits<float>::max());

    SmartStack<double> s4;
    assert(s4.GetMax() == std::numeric_limits<double>::min());
    ...
    SmartQueue<float> q3;
    assert(q3.GetMax() == std::numeric_limits<float>::min());
    assert(q3.GetMin() == std::numeric_limits<float>::max());

    SmartQueue<double> q4;
    assert(q4.GetMax() == std::numeric_limits<double>::min());
    ...
    assert(qs3.GetMax() == std::numeric_limits<float>::min());
    assert(qs3.GetMin() == std::numeric_limits<float>::max());

    QueueStack<double> qs4(1);
    assert(qs4.GetMax() == std::numeric_limits<double>::min());
